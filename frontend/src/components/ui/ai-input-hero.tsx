  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="text-slate-800 text-3xl sm:text-5xl font-semibold tracking-tight drop-shadow-sm">
            {title}
          </h1>
          ...
          >
            <div className="relative w-full sm:w-[720px]">
              <div className="relative rounded-2xl p-[2px] shadow-lg bg-white border border-slate-200">
                <textarea
                  value={prompt}
                  onChange={(e) => setPrompt(e.target.value)}
                  placeholder={animatedPlaceholder}
                  rows={5}
                  className="w-full h-32 sm:h-36 resize-none rounded-2xl bg-white text-slate-800 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 px-4 py-4 pr-16"
                />
              </div>
              <button
                type="submit"
                aria-label={buttonText}
                className="absolute right-3 bottom-3 inline-flex items-center justify-center w-10 h-10 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition-colors shadow-md"
              >
